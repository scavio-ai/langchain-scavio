"""Tests for the Scavio YouTube tools (8 endpoints)."""
...
CASES: list[tuple[Any, ...]] = [
    (
        ...
        {"query": "funny cats", "sort_by": "view_count"},
        {
            "results": [{"i": n} for n in range(12)],
            "next_cursor": "cur",
            "has_more": True,
        },
        "results",
        {"search": "funny cats", "sort_by": "view_count"},
        "No YouTube Shorts found for",
    ),
    (
        ScavioYouTubeSuggestions,
        "/api/v1/youtube/suggestions",
        {"query": "python tut", "region": "US"},
        {
            "suggestions": [{"i": n} for n in range(12)],
            "next_cursor": "cur",
            "has_more": True,
        },
        "suggestions",
        {"search": "python tut", "region": "US"},
        "No YouTube suggestions found for",
    ),
    (
        ScavioYouTubeCommentReplies,
        ...
        {
            "replies": [{"i": n} for n in range(12)],
            "next_cursor": "cur",
            "has_more": True,
        },
        "replies",
        {"video_id": "dQw4w9WgXcQ", "reply_cursor": "Eg0SC2"},
        "No replies found for that comment on YouTube video",
    ),
    (
        ScavioYouTubeRelated,
        ...
        "results",
        {"video_id": "dQw4w9WgXcQ"},
        "No related videos found for YouTube video",
    ),
    (
        ScavioYouTubeChannelSearch,
    ...
    (
        ...
        "results",
        {"channel_id": "@MrBeast"},
        "No Shorts found for YouTube channel",
    ),
    (
        ScavioYouTubeChannelCommunity,
        ...
        {"channel_id": "@MrBeast"},
        {
            "posts": [{"i": n} for n in range(12)],
            "next_cursor": "cur",
            "has_more": True,
        },
        "posts",
        {"channel_id": "@MrBeast"},
        "No community posts found for YouTube channel",
    ),
    (
        ScavioYouTubeChannelResolve,
